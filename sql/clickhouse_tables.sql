...
USE google_ads_staging;

-- ============================================================
-- 1. HOURLY CAMPAIGN LEVEL (базовая таблица-шаблон)
-- ============================================================

CREATE TABLE IF NOT EXISTS google_ads_website_traffic_hourly_campaign_level_staging
(
...
CREATE TABLE IF NOT EXISTS google_ads_sales_hourly_campaign_level_staging
AS google_ads_website_traffic_hourly_campaign_level_staging;

CREATE TABLE IF NOT EXISTS google_ads_leads_hourly_campaign_level_staging
AS google_ads_website_traffic_hourly_campaign_level_staging;

CREATE TABLE IF NOT EXISTS google_ads_app_promotion_hourly_campaign_level_staging
AS google_ads_website_traffic_hourly_campaign_level_staging;

CREATE TABLE IF NOT EXISTS google_ads_youtube_reach_views_engagement_hourly_campaign_level_staging
AS google_ads_website_traffic_hourly_campaign_level_staging;

CREATE TABLE IF NOT EXISTS google_ads_store_visits_promotions_hourly_campaign_level_staging
AS google_ads_website_traffic_hourly_campaign_level_staging;

CREATE TABLE IF NOT EXISTS google_ads_no_goal_hourly_campaign_level_staging
AS google_ads_website_traffic_hourly_campaign_level_staging;
...
CREATE TABLE IF NOT EXISTS google_ads_website_traffic_daily_ad_level_staging
(
    date_start DateTime('Asia/Almaty'),
    date_stop DateTime('Asia/Almaty'),
...
CREATE TABLE IF NOT EXISTS google_ads_sales_daily_ad_level_staging
AS google_ads_website_traffic_daily_ad_level_staging;

CREATE TABLE IF NOT EXISTS google_ads_leads_daily_ad_level_staging
AS google_ads_website_traffic_daily_ad_level_staging;

CREATE TABLE IF NOT EXISTS google_ads_app_promotion_daily_ad_level_staging
AS google_ads_website_traffic_daily_ad_level_staging;

CREATE TABLE IF NOT EXISTS google_ads_youtube_reach_views_engagement_daily_ad_level_staging
AS google_ads_website_traffic_daily_ad_level_staging;

CREATE TABLE IF NOT EXISTS google_ads_store_visits_promotions_daily_ad_level_staging
AS google_ads_website_traffic_daily_ad_level_staging;

CREATE TABLE IF NOT EXISTS google_ads_no_goal_daily_ad_level_staging
AS google_ads_website_traffic_daily_ad_level_staging;
...
CREATE TABLE IF NOT EXISTS google_ads_geo_daily_region_level_staging
(
    date_start DateTime('Asia/Almaty'),
    date_stop DateTime('Asia/Almaty'),
...
CREATE TABLE IF NOT EXISTS google_ads_website_traffic_daily_campaign_level_staging
(
    date_start DateTime('Asia/Almaty'),
    date_stop DateTime('Asia/Almaty'),
...
CREATE TABLE IF NOT EXISTS google_ads_sales_daily_campaign_level_staging
AS google_ads_website_traffic_daily_campaign_level_staging;

CREATE TABLE IF NOT EXISTS google_ads_leads_daily_campaign_level_staging
AS google_ads_website_traffic_daily_campaign_level_staging;

CREATE TABLE IF NOT EXISTS google_ads_app_promotion_daily_campaign_level_staging
AS google_ads_website_traffic_daily_campaign_level_staging;

CREATE TABLE IF NOT EXISTS google_ads_youtube_reach_views_engagement_daily_campaign_level_staging
AS google_ads_website_traffic_daily_campaign_level_staging;

CREATE TABLE IF NOT EXISTS google_ads_store_visits_promotions_daily_campaign_level_staging
AS google_ads_website_traffic_daily_campaign_level_staging;

CREATE TABLE IF NOT EXISTS google_ads_no_goal_daily_campaign_level_staging
AS google_ads_website_traffic_daily_campaign_level_staging;
...
CREATE TABLE IF NOT EXISTS google_ads_daily_search_term_level_staging
(
    date_start DateTime('Asia/Almaty'),
    date_stop DateTime('Asia/Almaty'),
...
CREATE TABLE IF NOT EXISTS google_ads_creative_assets_staging
(
    source_type String,
...
CREATE TABLE IF NOT EXISTS google_ads_gender_daily_level_staging
(
    date_start DateTime('Asia/Almaty'),
    date_stop DateTime('Asia/Almaty'),
...
ENGINE = MergeTree
PARTITION BY toYYYYMM(date_start)
ORDER BY (date_start, customer_id, campaign_id, ifNull(ad_group_id, ''), ifNull(gender_type, ''), device, ad_network_type);